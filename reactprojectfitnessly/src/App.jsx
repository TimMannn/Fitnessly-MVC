...
import WorkoutSessieResults from "./WorkoutSessieResults";
function App() {
      ...
      <Router>
          <div className="App">
              <Routes>
                  ...
                  {/* Route voor workoutsessie met workoutId, workoutName en optional workoutSessieId - beveiligd met authenticatie */}
                  <Route
                  ...
                  {/* Route voor workoutsessie resultaten - beveiligd met authenticatie */}
                  <Route
                      path="/workoutsessieresults/:workoutSessieId"
                      element={
                          isAuthenticated() ? <WorkoutSessieResults /> : <Navigate to="/login" />
                      }
                  />
